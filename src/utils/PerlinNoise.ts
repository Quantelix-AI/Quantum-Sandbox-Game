  ...
  noise(x: number, y: number, z: number): number {
    ...
    const result = lerp(
      ...
      lerp(
        ...
        lerp(
          u,
          grad(this.p[AA], xf, yf, zf),
          grad(this.p[BA], xf - 1, yf, zf),
        ),
        lerp(
          u,
          grad(this.p[AB], xf, yf - 1, zf),
          grad(this.p[BB], xf - 1, yf - 1, zf),
        ),
      ),
      lerp(
        v,
        lerp(
          u,
          grad(this.p[AA + 1], xf, yf, zf - 1),
          grad(this.p[BA + 1], xf - 1, yf, zf - 1),
        ),
        lerp(
          u,
          grad(this.p[AB + 1], xf, yf - 1, zf - 1),
          grad(this.p[BB + 1], xf - 1, yf - 1, zf - 1),
        ),
      ),
    );
